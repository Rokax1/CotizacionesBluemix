...
<div>
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <h3 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #1A2694;font-size: 28px;line-height: 36px;text-align: center;">COTIZACIÓN DESDE LA WEB EMPRESAS</h3>
        </div>
      </div>
        ...
        <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #1A2694;font-size: 18px;line-height: 26px;font-family: Cabin,Avenir,sans-serif;"><strong>EL CLIENTE {{$cliente->razon_social}}, HA GENERADO UNA NUEVA COTIZACIÓN!</strong></h2><p style="Margin-top: 16px;Margin-bottom: 20px; color:#1A2694;"></p>
