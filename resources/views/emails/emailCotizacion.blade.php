...
<div>
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <h3 style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #1A2694;font-size: 28px;line-height: 36px;text-align: center;">Hola, {{$cliente->razon_social}}!</h3>
        </div>
      </div>
        ...
        <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #1A2694;font-size: 18px;line-height: 26px;font-family: Cabin,Avenir,sans-serif;"><strong>Haz Generado Una Nueva Cotización!</strong></h2><p style="Margin-top: 16px;Margin-bottom: 20px; color:#1A2694;">Adjunto a este correo se encuentra el PDF de tu cotización.</p>
        ...
        <div class="btn btn--flat btn--large" style="text-align:center;">
          <a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #1A2694 !important;background-color: #F9D56E;font-family: Open Sans, sans-serif;" href="https://cotizador.bluemix.cl" target="_blank">Ingresar al Cotizador</a><!--[endif]-->
        </div>
      </div>
        ...
        <div style="line-height:80px;font-size:80px;">&nbsp;</div>
